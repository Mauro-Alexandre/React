    ...
    <main className="min-h-200">
      ...
      <div className="flex mb-10">
        <div className="p-30">
          ...
          <p className="text-[25px]">
            Aqui você encontra uma seleção especial <br /> de jogos incríveis
            para todos os gostos.
          </p>
          <br />
          <p className="text-[25px]">
            Explore nosso catálogo e descubra novas <br /> aventuras!
          </p>
          <br />
          <Link to="/jogos">
            <button
              className="bg-blue-600 h-16 w-60
              text-[23px]
              font-semibold
             text-white
              rounded-2xl
      ...
      <div className="flex gap-20 p-13 m-5 bg-cyan-100 rounded-3xl">
        <div className="transition-[scale] hover:scale-105">
          ...
          <p className="text-blue-500 font-bold border border-blue-700 w-20 text-center mt-1 mb-2">
            Aventura
          </p>
        ...
        <div className="transition-[scale] hover:scale-105">
          ...
          <p className="text-blue-500 font-bold border border-blue-700 w-22 text-center mt-2 mb-2">
            Simulação
          </p>
        ...
        <div className="transition-[scale] hover:scale-105">
          ...
          <p className="text-blue-500 font-bold border border-blue-700 w-20 text-center mt-2 mb-2">
            Aventura
          </p>
      ...
      <div className="flex justify-center">
        <Link to="/jogos">
          <button className="font-bold text-[23px] border text-blue-500 w-65 h-14 rounded-[10px] mb-10 mt-10 hover:text-blue-800 hover:transition-delay hover:transition hover:duration-160">
            Ver todos os jogos
          </button>
        </Link>
      </div>
