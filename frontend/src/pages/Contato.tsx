...
export default function Contatos()
{
    ...
    async function cadastrarContato(event: React.FormEvent<HTMLFormElement>)
    {
        ...
        try
        {
            ...
            if (!resposta.ok)
            {
                throw new Error("Error ao cadastrar contato");
            }
    ...
    return (
       <div className="mx-auto max-w-2x1" p-6>
            <h1 className="mb-6 text-center text-3x1 font-bold">Lista de Contatos</h1>
            ...
            <form onSubmit={editando ? atualizarContato : cadastrarContato} className="mb-6 space-y-4">
                <input type="text"  
                placeholder="Nome"
            value={form.name}
            onChange={(event) =>
